    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternativeName', models.CharField(blank=True, default=None, max_length=255, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='track',
            name='playlist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracks', to='home.playlist'),
        ),
        migrations.AddField(
            model_name='playlist',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='UserModerationLogReport', to='home.reportcontent')),
