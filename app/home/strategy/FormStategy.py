from home.strategy.formManager.InputManager import InputManager, PasswordInput, TextInputManager, FileInputManager, NumberInputManager, CheckboxInputManager, SelectInputManager
