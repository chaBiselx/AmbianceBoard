...
class RandomizeTrackServiceTest(TestCase):
    ...
    @patch('home.service.RandomizeTrackService.MusicFilter')
    @patch('home.service.RandomizeTrackService.RandomizeTrackService._get_random_music_from_playlist')
    ...
    @patch('home.service.RandomizeTrackService.SoundBoardService')
    @patch('home.service.RandomizeTrackService.MusicFilter')
    @patch('home.service.RandomizeTrackService.RandomizeTrackService._get_random_music_from_playlist')
    ...
    @patch('home.service.RandomizeTrackService.SoundBoardService')
    @patch('home.service.RandomizeTrackService.Track.objects')
