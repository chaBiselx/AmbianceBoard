...
from home.utils.logger.LoggerFactory import LoggerFactory
from home.utils.logger.ILogger import ILogger
from home.utils.logger.LoggerFile import LoggerFile
from home.utils.logger.MemoryLogger import MemoryLogger
...
class LoggerFactoryTestCase(TestCase):
    ...
    def test_create_logger_default_parameters(self):
        ...
        self.assertIsInstance(logger, LoggerFile)
        self.assertEqual(logger.logger_name, 'home')
    ...
    @patch('home.utils.logger.LoggerFactory.settings')
