...
from main.interface.ui.controller.general.generalViews import (
    home, faq, pricing,  create_account, login_view,login_post, 
    logout_view, resend_email_confirmation, send_reset_password, token_validation_reset_password, legal_notice, support_contact, dismiss_general_notification, dismiss_trace_user_activity, 
    callback_oauth_google, onboarding_context, set_language, healthcheck
)
...
urlpatterns = [
    ...
    path("soundBoards/<uuid:soundboard_uuid>/section/update", soundboard_organize_update, name="organizeSoundboardUpdate"),
